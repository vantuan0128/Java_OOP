...
public class DanhSachThucTap1 {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= n; ++i){
            ...
            SinhVien6 x = new SinhVien6(i, ma, ten, lop, mail, dn);
            list.add(x);
        }
...
class SinhVien6 implements Comparable <SinhVien6>{
    ...
    public SinhVien6(int stt, String ma, String ten, String lop, String mail, String dn) {
        this.stt = stt;
        this.ma = ma;
        this.ten = ten;
        this.lop = lop;
    ...
    public String toString() {
        return this.stt + " " + this.ma + " " + this.ten + " " 
                + this.lop + " " + this.mail + " " + this.dn;
    }
